...
final String appName = 'FarmBuz';

final String packageName = 'com.formbuxx.user';
final String androidLink = 'https://play.google.com/store/apps/details?id=';

final String iosPackage = 'com.formbuxx.user';
final String iosLink = 'your ios link here';
final String appStoreId = 'com.formbuxx.user';
