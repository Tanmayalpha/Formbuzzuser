...
class OrderDetail extends StatefulWidget {
  ...
  // final Function? updateHome;
   ...
   OrderDetail({Key? key, this.model,this.userLat,this.userLang,this.driverId}) : super(key: key);
                      ...
                      child: Column(children: [
                        ...
                        InkWell(
                                ...
                                return AlertDialog(
                                  ...
                                  actions: [
                                    TextButton(
                                      ...
                                      onPressed: () {
                                        addToCart(orderItem.varientId.toString(),orderItem.seller_id ??'');
                          ...
                          Container(
                            ...
                            height: 36,
                            child: Center(child: Text('${getTranslated(context, "REOEATORDER")}',style: TextStyle(fontSize: 13,color: Colors.red),),),
                          ),
                        ),
...
//                     :SizedBox.shrink(),
  ...
  Future<void> addToCart(String variatid, String seller_id) async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse('${baseUrl}manage_cart'));
...
print(request.fields);
    if (response.statusCode == 200) {
      ...
      if(finalresult['error']==false){
        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Dashboard(selBottomIndex: 3),));
